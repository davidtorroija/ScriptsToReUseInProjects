...
typeof c.headerCloseButton||c.headerCloseButton)d="<a href='javascript:;' class='close'>&times;</a>";a.push("<div class='modal-header'>"+d+"<h3>"+c.header+"</h3></div>")}a.push("<div class='modal-body'></div>");e&&a.push("<div class='modal-footer'><div class='invertButtons'>"+e+"</div></div>");a.push("</div>");var g=k(a.join("\n"));("undefined"===typeof c.animate?r:c.animate)&&g.addClass("fade");(e="undefined"===typeof c.classes?s:c.classes)&&g.addClass(e);k(".modal-body",g).html(b);g.bind("hidden",function(){g.remove()});g.bind("hide",
